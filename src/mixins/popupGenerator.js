      ...
      const renderer = {
        init: function initFunc() {
          ...
          function initPopup(dataObj) {
            ...
            /** Popup Wrapper */ let popup = createElement({
              elem: "DIV",
              id: "pt_popup",
              className: "pt_popup",
            ...
            /** Popup Inner */ let popupContent = createElement({
              elem: "DIV",
