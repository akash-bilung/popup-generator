    ...
    generatePopup(data) {
      const renderer = {
        init: function initFunc() {
          ...
          css.type = "text/css";
          css.innerHTML = `
          .pt_popup_input{background-color:#fff;width:100%;display:block;font-size:16px;color:#333;padding:10px;border-radius:5px;border:1px solid #e8e8e8}.pt_popup,.pt_popup_input_submit{text-align:center;width:100%;color:#fff}.pt_popup_input::placeholder{color:grey}.pt_popup_input:read-only{background-color:#e8e8e8}.pt_popup_input:focus{outline:0}@keyframes fadeIn{0%{opacity:0;visibility:hidden;transform:translate(-50%,-40%)}100%{opacity:1;visibility:visible;transform:translate(-50%,-50%)}}.pt_popup{animation:1s linear 1s forwards fadeIn;opacity:0;visibility:hidden;font-family:Arial,Helvetica,sans-serif;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);border-radius:100%;max-width:500px;aspect-ratio:1;display:flex;justify-content:center;padding-top:calc(500px * .15)}.pt_popup,.pt_popup *{box-sizing:border-box}.pt_popup_content{max-width:60%}.pt_popup_content>:not(:last-child){margin-bottom:20px}.pt_popup_icons{display:flex;align-items:center;justify-content:center}.pt_popup_icons.icons-top>svg:nth-child(2):not(:last-child){transform:scale(1.6) translateY(-8px)}.pt_popup_icons.icons-bottom>svg:nth-child(2):not(:last-child){transform:scale(1.6) translateY(8px)}.pt_popup_icons>svg{transform:scale(1.2);transform-origin:center}.pt_popup_icons>svg:nth-child(2):not(:last-child){transform:scale(1.6)}.pt_popup_icons>svg:not(:last-child){margin-right:30px}.pt_popup_title{font-size:24px;font-weight:600}.pt_popup_input_submit{cursor:pointer;text-transform:uppercase;padding:12px 10px;font-size:12px;border-radius:10px;display:block;font-weight:600;background:#000;border:1px solid transparent}@media only screen and (max-width:768px){.pt_popup{padding-top:calc(500px * .15)}.pt_popup_content{max-width:65%}.pt_popup_title{font-size:22px}}@media only screen and (max-width:480px){.pt_popup{padding-top:calc(500px * .07)}.pt_popup_content{max-width:60%}.pt_popup_title{font-size:18px}}
          `;
